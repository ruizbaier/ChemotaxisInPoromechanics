...
# ******* Output file 
fileO = XDMFFile(mesh.mpi_comm(), "outputs/NH-RD-growth-Fig11-MSet1.xdmf")
...
mu1  = Constant(0.005)
mu2  = Constant(0.015)
rho1 = Constant(0.002)#0.002,0.006,0.01,0.02
rho2 = Constant(0.05)
Kh   = Constant(0.01)
kappa= Constant(0.1)
...
w20 = Constant(0.0237564)#0.0237564,0.406486,1.13891,4.1783
